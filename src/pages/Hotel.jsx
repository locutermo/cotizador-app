...
import { addHotel, editHotel, removeHotel } from "../features/hotels/thunks";
import { hotelsFormattedSelector } from "../features/hotels/hotelSlice";
import { useState } from "react";
export default function Hotels() {
    const dispatch = useDispatch()
    const [selected, setSelected] = useState()
    const hotels = useSelector(hotelsFormattedSelector)
            ...
            Component: ({ element }) => {
                return (
                    <div className="flex items-center justify-center">
                        {
                            [...Array(5).keys()].map((e) => (
                                <svg xmlns="http://www.w3.org/2000/svg" fill={`${(e) < element['stars'] ? 'orange' : 'none'}`} viewBox="0 0 24 24" strokeWidth="1.5" stroke="yellow" className="size-6">
        ...
        <>
            ...
            <div className="flex gap-4">
                ...
                <div className="w-9/12">
                    <Table data={hotels} headers={headers} />
                </div>
            </div>
